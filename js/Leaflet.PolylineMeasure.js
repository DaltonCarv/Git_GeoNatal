    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _updateTooltip: function (currentTooltip, prevTooltip, total, difference, lastCircleCoords, mouseCoords) {
            ...
            if (differenceRound.value > 0 ) {
                ...
                textCurrent += '<div class="polyline-measure-tooltip-difference">' + 'Entre pontos: ' + differenceRound.value + '&nbsp;' +  differenceRound.unit + '</div>';
            }
            textCurrent += '<div class="polyline-measure-tooltip-total">' + 'Total: ' + totalRound.value + '&nbsp;' +  totalRound.unit + '</div>';
